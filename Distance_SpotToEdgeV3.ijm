// A Script that measures minimum length between spot of interest (Green or Red Ch) and nucleus edge (Blue Ch)
...
Dialog.addChoice("Type:", newArray("Green", "Red"));//Just needed for output  results label
Dialog.show();
